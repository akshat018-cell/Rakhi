                            ...
                            >
                                ...
                                >
                                    <div className="absolute inset-6 border-2 border-cyan-400/30 rounded-lg flex flex-col items-center justify-center text-white">
                                        ...
                                        <h3 className="text-2xl font-bold mb-2 text-center">Siblings</h3>
                                        <h3 className="text-2xl font-bold mb-4 text-center">Moments</h3>
                        ...
                        >
                            <div className="flex justify-center">
                                ...
                                >
                                    ...
                                    >
                                        <motion.div
                                            className="relative w-[480px] h-[270px] rounded-xl overflow-hidden shadow-2xl border-4 border-cyan-50" // 480x270 is 16:9 landscape, larger
