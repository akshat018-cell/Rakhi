...
export default function FinalMessageScreen() {
  ...
  const messages = [
    // "Hey Bro! 🤜🤛",
    // "15+ years of madness, memories, and brotherhood.",
    // "From school benches to grown-up messes — we've seen it all.",
    // "You've been more than a friend — you're family.",
    // "Thanks for having my back every damn time, no questions asked.",
    // "Let’s keep this bond unshakable — for life.",
    // "Happy Friendship Day, my brother from another mother! 🥂💯",

    "Mere pyaare Bhai-Behen, jinke bina zindagi adhoori si lagti hai. ❤️🪢",
    "Bachpan ki shararatein ho ya aaj ka saath — sab kuch yaad hai ❤️",
    "Do behnein — chulbuli, mastikhor, adaon ki shehzadiyaan, 💄✨",
    "Rakhi baandhte hi aankhon mein chamak, aur demands ki tayyariyaan. 😅💰",
    "Har gift pe ho jaye drama, har note pe ho andolan, 💸📢",
    "Jaise rakhi ke saath milti ho, hidden charges wali chalan. 🧾😂",
    "Mohabbat kam, maze zyada — ye hi hai hamari team, 🤪",
    "Par is bandhan mein hi chhupi hai, sabse badi dream. ❤️🪢",
  ]
